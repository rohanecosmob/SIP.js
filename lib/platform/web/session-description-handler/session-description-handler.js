...
export class SessionDescriptionHandler {
    ...
    getDescription(options, modifiers) {
        ...
        return this.getLocalMediaStream(options)
            ...
            sessionDescription.sdp.replace("useinbandfec=1", "usedtx=1;useinbandfec=1; maxaveragebitrate=64000; maxplaybackrate=16000; sprop-maxcapturerate=16000; ptime=20; maxptime=40;minptime=10; stereo=0");
            return {
